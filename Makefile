...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -O2 -MD -ggdb -m32 -Werror
...
ULIB = ulib.o usys.o printf.o scanf.o umalloc.o math.o common.o huffman.o decodemp3.o
...
fs.img: mkfs README $(UPROGS)
	./mkfs fs.img README $(UPROGS) qian.wav in.mp3 dewindow.txt huffdec.txt
